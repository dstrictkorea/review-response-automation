...
export const DICT: Record<Language, I18nDict> = {
  ko: {
    ...
    rd_reanalyze: '🔄 AI 재분석',
    rd_analyzing: '분석 중...',
    rd_reanalyze_title: '결정론적 엔진으로 재분석 — 위험도 재평가 및 초안 재생성',
    rd_tab_standard: '표준',
    rd_tab_short: '짧게',
  ...
  en: {
    ...
    rd_reanalyze_title: 'Re-analyze with deterministic engine — re-evaluate risk and regenerate drafts',
  ...
  ja: {
    ...
    rd_reanalyze: '🔄 AI再分析',
    rd_analyzing: '分析中...',
    rd_reanalyze_title: '決定論的エンジンでAI再分析 — リスク再評価と返信案の再生成',
    rd_tab_standard: '標準',
    rd_tab_short: '簡潔',
    rd_tab_careful: '丁寧',
  ...
  zh: {
    ...
    rd_reanalyze: '🔄 AI重新分析',
    rd_analyzing: '分析中...',
    rd_reanalyze_title: '使用决定性引擎重新分析 — 重新评估风险并重新生成草稿',
    rd_tab_standard: '标准',
    rd_tab_short: '简短',
    rd_tab_careful: '谨慎',
