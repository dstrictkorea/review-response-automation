...
Cron, n8n workflow, monthly report, failure alert schedule을 설계한다.
...
- `ARCH_04_N8N_WORKFLOWS.md`
- `OPS_01_DAILY_OPERATIONS_SOP.md`

## 5. Command Pattern

```text
Use skillfish skill: production-scheduling
