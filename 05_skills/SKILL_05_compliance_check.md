...
Google/TripAdvisor/Naver 정책 리스크와 금지 행위를 검토한다.
...
- `POLICY_01_CHANNEL_AUTOMATION_LOCK.md`
- `POLICY_07_SCRAPING_BROWSER_AUTOMATION.md`

## 5. Command Pattern

```text
Use skillfish skill: compliance-check
